...
<html>
    ...
    <body class="loanCalc">
            ...
            <section class="FormInfo">
                <form class="FormInfoInput">
                    ...
                    <div class="input_area">
                        ...
                        <div>
                            <div class="info">
                                <input type="number" name="payments_amount" step="1" min="1" value="15" max="50" required pattern="[1-9][0-9]+" placeholder="Обязательное поле">
                                <p>Лет</p>
                            </div>
                            <div class="wrapper">
                    ...
                    <div class="input_area">
                        ...
                        <div>
                            ...
                            <div class="wrapper">
                                <input type="range" min="1" max="81" step="1" value="10" class="interest">
        ...
        <section class="Actions">
            <button onclick="loan.sendLoanRequest();">Подать заявку онлайн</button>
            <button onclick="loan.sendToMyEmail();">Переслать себе на E-mail</button>
        </section>
